...
export const MealForm = ({ onSubmit, initialValues }: MealFormProps) => {
    const form = useForm({
        defaultValues: {
            date: initialValues?.date ?? nowDate(),
            time: initialValues?.time ?? nowTime(),
            name: initialValues?.name ?? "",
            ingredients: initialValues?.ingredients ?? ([] as MenuIngredient[]),
        },
