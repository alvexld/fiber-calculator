...
export type CreateBristolMutation = {
    __typename?: "Mutation";
    createBristol: {
        __typename?: "Bristol";
        id: string;
...
export const useBristolsQuery = <TData = BristolsQuery, TError = unknown>(
    variables?: BristolsQueryVariables,
    options?: Omit<UseQueryOptions<BristolsQuery, TError, TData>, "queryKey"> & {
        queryKey?: UseQueryOptions<BristolsQuery, TError, TData>["queryKey"];
    },
) => {
...
useBristolsQuery.getKey = (variables?: BristolsQueryVariables) =>
    variables === undefined ? ["Bristols"] : ["Bristols", variables];

useBristolsQuery.fetcher = (variables?: BristolsQueryVariables, options?: RequestInit["headers"]) =>
    fetcher<BristolsQuery, BristolsQueryVariables>(BristolsDocument, variables, options);
...
export const useCreateBristolMutation = <TError = unknown, TContext = unknown>(
    options?: UseMutationOptions<
        CreateBristolMutation,
        TError,
        CreateBristolMutationVariables,
        TContext
    >,
) => {
    return useMutation<CreateBristolMutation, TError, CreateBristolMutationVariables, TContext>({
        mutationKey: ["CreateBristol"],
        mutationFn: (variables?: CreateBristolMutationVariables) =>
            fetcher<CreateBristolMutation, CreateBristolMutationVariables>(
                CreateBristolDocument,
                variables,
            )(),
        ...options,
    });
...
useCreateBristolMutation.fetcher = (
    variables: CreateBristolMutationVariables,
...
export const useDeleteBristolMutation = <TError = unknown, TContext = unknown>(
    options?: UseMutationOptions<
        DeleteBristolMutation,
        TError,
        DeleteBristolMutationVariables,
        TContext
    >,
) => {
    return useMutation<DeleteBristolMutation, TError, DeleteBristolMutationVariables, TContext>({
        mutationKey: ["DeleteBristol"],
        mutationFn: (variables?: DeleteBristolMutationVariables) =>
            fetcher<DeleteBristolMutation, DeleteBristolMutationVariables>(
                DeleteBristolDocument,
                variables,
            )(),
        ...options,
    });
...
useDeleteBristolMutation.fetcher = (
    variables: DeleteBristolMutationVariables,
    options?: RequestInit["headers"],
) =>
    fetcher<DeleteBristolMutation, DeleteBristolMutationVariables>(
        DeleteBristolDocument,
...
export const useIngredientsQuery = <TData = IngredientsQuery, TError = unknown>(
    ...
    options?: Omit<UseQueryOptions<IngredientsQuery, TError, TData>, "queryKey"> & {
        queryKey?: UseQueryOptions<IngredientsQuery, TError, TData>["queryKey"];
    },
) => {
    return useQuery<IngredientsQuery, TError, TData>({
        queryKey: variables === undefined ? ["Ingredients"] : ["Ingredients", variables],
        queryFn: fetcher<IngredientsQuery, IngredientsQueryVariables>(
            IngredientsDocument,
            variables,
        ),
        ...options,
...
useIngredientsQuery.getKey = (variables?: IngredientsQueryVariables) =>
    variables === undefined ? ["Ingredients"] : ["Ingredients", variables];

useIngredientsQuery.fetcher = (
    variables?: IngredientsQueryVariables,
    options?: RequestInit["headers"],
) => fetcher<IngredientsQuery, IngredientsQueryVariables>(IngredientsDocument, variables, options);
...
export const useCreateIngredientMutation = <TError = unknown, TContext = unknown>(
    ...
    >({
        ...
        mutationFn: (variables?: CreateIngredientMutationVariables) =>
...
useCreateIngredientMutation.fetcher = (
...
export const useUpdateIngredientMutation = <TError = unknown, TContext = unknown>(
    ...
    >({
        ...
        mutationFn: (variables?: UpdateIngredientMutationVariables) =>
...
useUpdateIngredientMutation.fetcher = (
...
export const useDeleteIngredientMutation = <TError = unknown, TContext = unknown>(
    ...
    >({
        ...
        mutationFn: (variables?: DeleteIngredientMutationVariables) =>
...
useDeleteIngredientMutation.fetcher = (
...
export const useMealsQuery = <TData = MealsQuery, TError = unknown>(
    variables?: MealsQueryVariables,
    options?: Omit<UseQueryOptions<MealsQuery, TError, TData>, "queryKey"> & {
        queryKey?: UseQueryOptions<MealsQuery, TError, TData>["queryKey"];
    },
) => {
...
useMealsQuery.getKey = (variables?: MealsQueryVariables) =>
    variables === undefined ? ["Meals"] : ["Meals", variables];

useMealsQuery.fetcher = (variables?: MealsQueryVariables, options?: RequestInit["headers"]) =>
    fetcher<MealsQuery, MealsQueryVariables>(MealsDocument, variables, options);
...
export const useMealQuery = <TData = MealQuery, TError = unknown>(
    variables: MealQueryVariables,
    options?: Omit<UseQueryOptions<MealQuery, TError, TData>, "queryKey"> & {
        queryKey?: UseQueryOptions<MealQuery, TError, TData>["queryKey"];
    },
) => {
...
useMealQuery.fetcher = (variables: MealQueryVariables, options?: RequestInit["headers"]) =>
    fetcher<MealQuery, MealQueryVariables>(MealDocument, variables, options);
...
export const useCreateMealMutation = <TError = unknown, TContext = unknown>(
    ...
    return useMutation<CreateMealMutation, TError, CreateMealMutationVariables, TContext>({
        ...
        mutationFn: (variables?: CreateMealMutationVariables) =>
            fetcher<CreateMealMutation, CreateMealMutationVariables>(
                CreateMealDocument,
                variables,
            )(),
        ...options,
...
useCreateMealMutation.fetcher = (
    variables: CreateMealMutationVariables,
    options?: RequestInit["headers"],
) =>
    fetcher<CreateMealMutation, CreateMealMutationVariables>(
        CreateMealDocument,
...
export const useUpdateMealMutation = <TError = unknown, TContext = unknown>(
    ...
    return useMutation<UpdateMealMutation, TError, UpdateMealMutationVariables, TContext>({
        ...
        mutationFn: (variables?: UpdateMealMutationVariables) =>
            fetcher<UpdateMealMutation, UpdateMealMutationVariables>(
                UpdateMealDocument,
                variables,
            )(),
        ...options,
...
useUpdateMealMutation.fetcher = (
    variables: UpdateMealMutationVariables,
    options?: RequestInit["headers"],
) =>
    fetcher<UpdateMealMutation, UpdateMealMutationVariables>(
        UpdateMealDocument,
...
export const useDeleteMealMutation = <TError = unknown, TContext = unknown>(
    ...
    return useMutation<DeleteMealMutation, TError, DeleteMealMutationVariables, TContext>({
        ...
        mutationFn: (variables?: DeleteMealMutationVariables) =>
            fetcher<DeleteMealMutation, DeleteMealMutationVariables>(
                DeleteMealDocument,
                variables,
            )(),
        ...options,
...
useDeleteMealMutation.fetcher = (
    variables: DeleteMealMutationVariables,
    options?: RequestInit["headers"],
) =>
    fetcher<DeleteMealMutation, DeleteMealMutationVariables>(
        DeleteMealDocument,
